...
从 git log 获取最近 3 次 commit，不要只写总结。
格式：

```
- 2025-10-03 abc1234 原始 commit 简要说明
- 2025-09-15 def5678 原始 commit 简要说明
- 2025-08-20 ghi9012 原始 commit简要说明
```

简要说明就是一句解读，但原始 commit 信息也得保留。
